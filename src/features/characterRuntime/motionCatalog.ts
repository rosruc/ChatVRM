...
export const MOTIONS = {
  ...
  sit_2: {
    ...
    kind: "state",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/sit_idle2.bvh",
    loop: true,
    expression: { mood: "neutral" },
  },
  sit_3: {
    ...
    kind: "state",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/sit_idle3.bvh",
    loop: true,
    expression: { mood: "neutral" },
  },
  sit_4: {
    ...
    kind: "state",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/sit_idle4.bvh",
    loop: true,
    expression: { mood: "neutral" },
  },
  kneel: {
  ...
  laying_3: {
    ...
    kind: "state",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/laying_idle3.bvh",
    loop: true,
    expression: { mood: "neutral" },
  },
  sad: {
  ...
  waiting_1: {
    ...
    kind: "quirk",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/neutral4.bvh",
    loop: false,
    expression: { emote: "angry", emoteWeight: 0.24, emoteDurationSec: 2.5 },
  },
  gratitude: {
    id: "gratitude",
    kind: "quirk",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/gratitude.bvh",
    loop: false,
    expression: { emote: "happy", emoteWeight: 0.6, emoteDurationSec: 2.5 },
  },
  disgust: {
    id: "disgust",
    kind: "quirk",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/disgust.bvh",
    loop: false,
    expression: { emote: "angry", emoteWeight: 0.8, emoteDurationSec: 4.5 },
  },
  anger: {
    id: "anger",
    kind: "quirk",
    format: "bvh",
    url: "/assets/vrm/animation/bvh/anger.bvh",
    loop: false,
    expression: { emote: "angry", emoteWeight: 0.8, emoteDurationSec: 9.5 },
  },
  wave: {
    id: "wave",
    kind: "quirk",
